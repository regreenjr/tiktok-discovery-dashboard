...
// Color palette for the bars (blue tones)
const COLORS = ['#3B82F6', '#60A5FA', '#93C5FD', '#BFDBFE', '#DBEAFE']

export function FormatComparisonChart({ data }: FormatComparisonChartProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Format Comparison</h3>
